...
class Node:
    def __init__(self, NodeID, index):
        ...
        self.Direction = [None, None, None]  # The name, length, and bearing of the edge used to arrive at a node from its parent
        ...
        self.yx = (None, None)  # Lat/Long of a given node. Used for bearing
